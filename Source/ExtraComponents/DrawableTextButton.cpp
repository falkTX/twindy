// DrawableTextButton - Simple wrapper class which makes a DrawableButton
...
//------------------------------------------------------------------------------
DrawableTextButton::DrawableTextButton(const String& buttonName, const String& buttonText)
    : DrawableButton(buttonName, ImageOnButtonBackground),
      textColour(Colours::black)
{
    this->buttonText = buttonText;
#if JUCE_NEW
    drawableText.setFont(buttonFont, false);
    drawableText.setText(buttonText);
#else
