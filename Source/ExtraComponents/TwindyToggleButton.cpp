...
//------------------------------------------------------------------------------
void TwindyToggleButton::setColours(const Colour& backCol, const Colour& textCol)
{
...
//------------------------------------------------------------------------------
void TwindyToggleButton::paintButton(Graphics& g, bool /*isMouseOverButton*/, bool /*isButtonDown*/)
{
    ...
    AffineTransform trans (AffineTransform::identity.scaled(tickWidth / 9.0f, tickWidth / 9.0f).translated(4.0f, (getHeight() - tickWidth) * 0.5f));
    ...
    g.drawFittedText (getButtonText(), textX, 6, getWidth() - textX, getHeight() - 8, Justification::centredLeft, 10);
}
